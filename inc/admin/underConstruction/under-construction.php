...
function under_construction_register_settings() {
    ...
    register_setting('under_construction_options_group', 'under_construction_background_color2');
...
function under_construction_enqueue_media_uploader($hook) {
    ...
    wp_enqueue_media();
    wp_enqueue_script('under-construction-media', get_template_directory_uri() . '/inc/admin/underConstruction/index.js', ['jquery'], null, true);
}
...
function under_construction_page() {
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/inc/admin/underConstruction/style.css">
    <script src="<?php echo get_template_directory_uri(); ?>/inc/admin/underConstruction/index.js"></script>


    <div class="container d-flex" style="display: flex;"> 
                            ...
                            <table class="form-table">
                                <tr valign="top">
                                    <td>
                                        <div class="row">
                                            <?php
                                            $templates_uri = get_template_directory_uri() . '/inc/admin/underConstruction/images/';
                                            $templates = array(
                                                'templ-1' => 'Template 1',
                                                'templ-2' => 'Template 2',
                                                'templ-3' => 'Template 3',
                        ...
                        // Check which template is chosen met de templ-1.active class
                            ...
                            <?php } elseif ($chosen_template === 'templ-3') {
                                ...
                                <table class="form-table">
                                    ...
                                    <tr valign="top">
                                        <th scope="row">Social media Aankondiging</th>
                                        <td>
                                            ...
                                            <p class="small">De tekst die op de onder constructie pagina wordt weergegeven voor de social media aankondiging.</p>
                                        </td>
                                    </tr>
                                    <tr valign="top">
                                        <th scope="row">Social Media Links</th>
                            ...
                            <?php
                            } elseif ($chosen_template === 'templ-4') { ?>
                                <table class="form-table">
                                    ...
                                    <tr valign="top">
                                        ...
                                        <td>
                                            <input type="text" name="under_construction_heading" value="<?php echo esc_attr(get_option('under_construction_heading', 'Komt er aan!')); ?>" class="regular-text">
                                            <p class="small">De koptekst die op de onder constructie pagina wordt weergegeven.</p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr valign="top">
                                        <th scope="row">Achtergrondkleur</th>
                                        <td>
                                            <input type="color" name="under_construction_background_color" id="under_construction_background_color"
                                                value="<?php echo esc_attr(get_option('under_construction_background_color', '#006699')); ?>">
                                            <input type="hidden" name="under_construction_text_color" id="under_construction_text_color"
                                    ...
                                    <tr valign="top">
                                        <th scope="row">Achtergrondkleur onderaan</th>
                                        <td>
                                            <input type="color" name="under_construction_background_color2" id="under_construction_background_color2"
                                                value="<?php echo esc_attr(get_option('under_construction_background_color2', '#006699')); ?>">
                                            <p class="small">Stel hier jouw achtergrondkleur in. De tekstkleur wordt automatisch aangepast, zodat deze altijd goed leesbaar is.</p>
                                        </td>
                                    </tr>
        ...
        <div class="wrap" style="max-width: 30%; margin-top: 125px;">
            ...
            <p class="small">U kunt ons bereiken via e-mail op <a href="mailto:info@madeit.be">info@madeit.be</a>.</p>
        </div>
    </div>
    <?php
}

function under_construction_forced_by_setup_wizard(): bool {
    if (!defined('MADEIT_SETUP_WIZARD') || !MADEIT_SETUP_WIZARD) {
        return false;
    }

    if (!function_exists('madeit_setup_requires_child_theme')) {
        return false;
    }

    // If a child theme is still required, setup is not complete yet.
...
function under_construction_template_redirect() {
    ...
    $forced_mode = under_construction_forced_by_setup_wizard();
    if ($mode !== 'on' && !$forced_mode) return;
    ...
    $chosen_template = get_option('under_construction_template', 'templ-1');
    $relative_template = 'inc/admin/underConstruction/templates/' . $chosen_template . '.php';
    // locate_template zoekt eerst in child theme, daarna parent theme
    $template_path = locate_template([$relative_template]);

    if (!empty($template_path) && file_exists($template_path)) {
        // Onderhoudspagina: geef een correcte statuscode en disable caching
        status_header(503);
        nocache_headers();
