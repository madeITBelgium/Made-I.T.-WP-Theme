...
class MadeIT_Updater {
    ...
    function __construct( $themeFile, $gitHubUsername, $gitHubProjectName, $accessToken = '' ) {
        add_filter( "pre_set_site_transient_update_themes", array( $this, "setTransitent" ) );
        add_filter( "themes_api", array( $this, "setThemeInfo" ), 10, 3 );
        add_filter( 'upgrader_source_selection', array( $this, 'themeUpgraderSourceSelection' ), 10, 4 );
