<?php defined( 'ABSPATH' ) || exit; // phpcs:disable WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound -- template variables set by calling function ?>
    ...
    $checks = [
        ...
        [ 'label' => 'Auto-Update WordPress Core',           'ok' => (bool) \MadeIT\Security\Settings::get( 'madeit_security_auto_update_core', false ),               'opt' => 'madeit_security_auto_update_core',      'desc' => 'Automatically install WordPress core updates (only in the configured time window)' ],
