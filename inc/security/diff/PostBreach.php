...
class PostBreach {
    ...
    private static function action_generate_report(): array {
        ...
        $report = [
            'meta' => [
                'report_type'  => 'Atlant Security Incident Report',
                'site_name'    => $site,
                'site_url'     => $url,
    ...
    public static function get_action_definitions(): array {
        return [
            ...
            [
                ...
                'desc'     => 'Deactivates every plugin except Atlant Security. A backup of your active plugin list is saved so you can restore them with one click once the site is clean. Useful for isolating which plugin was exploited.',
                'severity' => 'high',
                'confirm'  => 'All plugins except Atlant Security will be deactivated. Your active plugin list is backed up for easy restoration. Continue?',
