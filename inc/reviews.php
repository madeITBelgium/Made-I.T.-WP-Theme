...
if (function_exists('acf_add_local_field_group')) {
	...
	acf_add_local_field_group( array(
        'key' => 'group_69dcee4f19a07',
        'title' => 'Reviews',
        'fields' => array(
            array(
                'key' => 'field_69dcef15999fb',
                'label' => 'Algemeen',
                'name' => '',
                'aria-label' => '',
                'type' => 'tab',
...
add_action( 'init', function() {
	register_taxonomy( 'review_category', array(
	0 => 'review',
    ), array(
        'labels' => array(
            'name' => 'Categories',
            ...
            'menu_name' => 'Categorie',
            'all_items' => 'Alle Categorie',
            'edit_item' => 'Bewerk Categorie',
            'view_item' => 'Bekijk Categorie',
            'update_item' => 'Bijwerken Categorie',
            ...
            'separate_items_with_commas' => 'Scheid categorie met komma\'s',
            'add_or_remove_items' => 'Toevoegen of verwijderen categorie',
            'choose_from_most_used' => 'Kies uit de meest gebruikte categorie',
            'not_found' => 'Geen categorie gevonden',
            'no_terms' => 'Geen categorie',
            'items_list_navigation' => 'Categorie lijst navigatie',
            'items_list' => 'Categorie lijst',
            'back_to_items' => '← Ga naar categorie',
            'item_link' => 'Categorie link',
            'item_link_description' => 'Een link naar een categorie',
        ),
        'public' => false,
        'show_ui' => true,
        'show_in_menu' => true,
