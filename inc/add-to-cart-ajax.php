...
if(!function_exists('madeit_woocommerce_ajax_add_to_cart_js')) {
    function madeit_woocommerce_ajax_add_to_cart_js() {
        if (function_exists('is_product') && MADEIT_BOOTSTRAP_VERSION == 5) {
            wp_enqueue_script('woocommerce-ajax-add-to-cart',get_template_directory_uri().'/assets/bootstrap-5/ajax-add-to-cart.js', array('jquery'), '', true);
        } else if (function_exists('is_product')) {
            wp_enqueue_script('woocommerce-ajax-add-to-cart',get_template_directory_uri().'/assets/bootstrap-46/ajax-add-to-cart.js', array('jquery'), '', true);
        }
    }
