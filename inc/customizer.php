...
function madeit_customize_preview_js() {
	wp_enqueue_script( 'madeit-customize-preview', get_theme_file_uri( '/assets/js/customize-preview.js' ), array( 'customize-preview' ), '1.0', true );
}
...
function madeit_panels_js() {
	wp_enqueue_script( 'madeit-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array(), '1.0', true );
}
