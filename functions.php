...
function madeit_setup() {
	 ...
	 * specifically font, colors, and column width.
 	 */
	add_editor_style(array('assets/css/editor-style.css', madeit_fonts_url()));
...
function madeit_scripts() {
	...
	wp_enqueue_style( 'madeit-fonts', madeit_fonts_url(), array(), null );

	// Theme stylesheet.
	wp_enqueue_style( 'madeit-style', get_stylesheet_uri() );
	
	wp_enqueue_style( 'font-awesome', get_theme_file_uri( '/assets/css/font-awesome.min.css' ), array( 'madeit-style' ), '4.7.0' );

	// Load the dark colorscheme.
	if ( 'dark' === get_theme_mod( 'colorscheme', 'light' ) || is_customize_preview() ) {
		wp_enqueue_style( 'madeit-colors-dark', get_theme_file_uri( '/assets/css/colors-dark.css' ), array( 'madeit-style' ), '1.0' );
	}

	// Load the Internet Explorer 9 specific stylesheet, to fix display issues in the Customizer.
	if ( is_customize_preview() ) {
		wp_enqueue_style( 'madeit-ie9', get_theme_file_uri( '/assets/css/ie9.css' ), array( 'madeit-style' ), '1.0' );
		wp_style_add_data( 'madeit-ie9', 'conditional', 'IE 9' );
	}

	// Load the Internet Explorer 8 specific stylesheet.
	wp_enqueue_style( 'madeit-ie8', get_theme_file_uri( '/assets/css/ie8.css' ), array( 'madeit-style' ), '1.0' );
	...
	wp_enqueue_script( 'madeit-skip-link-focus-fix', get_theme_file_uri( '/assets/js/skip-link-focus-fix.js' ), array(), '1.0', true );

	$madeit_l10n = array(
		'quote'          => madeit_get_svg( array( 'icon' => 'quote-right' ) ),
	);
	
	//TODO Delete
	if ( has_nav_menu( 'top' ) ) {
		wp_enqueue_script( 'madeit-navigation', get_theme_file_uri( '/assets/js/navigation.js' ), array( 'jquery' ), '1.0', true );
		$madeit_l10n['expand']         = __( 'Expand child menu', 'madeit' );
		$madeit_l10n['collapse']       = __( 'Collapse child menu', 'madeit' );
		$madeit_l10n['icon']           = madeit_get_svg( array( 'icon' => 'angle-down', 'fallback' => true ) );
	}

	wp_enqueue_script( 'popper', get_theme_file_uri( '/assets/js/popper.min.js' ), array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'bootstrap', get_theme_file_uri( '/assets/js/bootstrap.js' ), array( 'jquery', 'popper' ), '4.0.0', true );
	
	wp_enqueue_script( 'madeit-global', get_theme_file_uri( '/assets/js/global.js' ), array( 'jquery' ), '1.0', true );
