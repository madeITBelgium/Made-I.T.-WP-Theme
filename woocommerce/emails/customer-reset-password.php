...
<p>
	<a class="link" href="<?php echo esc_url(add_query_arg(['key' => $reset_key, 'login' => rawurlencode($user_login)], wc_get_endpoint_url('lost-password', '', wc_get_page_permalink('myaccount')))); ?>">
