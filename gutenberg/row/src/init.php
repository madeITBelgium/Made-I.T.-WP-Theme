 ...
 * @since 1.0.0
 */
function row_madeit_block_assets()
{
    // Styles.
    wp_enqueue_style(
...
} // End function row_madeit_block_assets().

// Hook: Frontend assets.
add_action('enqueue_block_assets', 'row_madeit_block_assets');
 ...
 * @since 1.0.0
 */
function row_madeit_editor_assets()
{
    // Scripts.
    wp_enqueue_script(
...
} // End function row_madeit_editor_assets().

// Hook: Editor assets.
add_action('enqueue_block_editor_assets', 'row_madeit_editor_assets');
