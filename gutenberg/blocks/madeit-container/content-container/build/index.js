...
/* harmony export */   "default": () => (/* binding */ AdvancedUnitSelect)
/* harmony export */ });
...
function AdvancedUnitSelect({
  ...
  const [showCustom, setShowCustom] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(value === '__custom__');
...
function ColumnsEditContainer(props) {
  ...
  const maxWidthCustomKey = activeMaxWidthBreakpoint === 'tablet' ? 'maxWidthCustomTablet' : activeMaxWidthBreakpoint === 'mobile' ? 'maxWidthCustomMobile' : 'maxWidthCustom';
  ...
  const minHeightCustomKey = activeMinHeightBreakpoint === 'tablet' ? 'minHeightCustomTablet' : activeMinHeightBreakpoint === 'mobile' ? 'minHeightCustomMobile' : 'minHeightCustom';
  ...
  const currentMaxWidthCustom = attributes?.[maxWidthCustomKey] || '';
  ...
  if (maxWidthUnitTablet === '__custom__') {
    if (maxWidthCustomTablet) {
      style['--madeit-max-width-tablet'] = maxWidthCustomTablet;
    }
  ...
  if (maxWidthUnitMobile === '__custom__') {
    if (maxWidthCustomMobile) {
      style['--madeit-max-width-mobile'] = maxWidthCustomMobile;
    }
  ...
  return [(0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    afterBreakpoint: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_shared__WEBPACK_IMPORTED_MODULE_11__.AdvancedUnitSelect, {
      ...
      onCustomChange: custom => setAttributes({
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__.registerBlockType)(_block_json__WEBPACK_IMPORTED_MODULE_4__.name, {
  ...
  // Meest recente tussenfase vóór de huidige save.
  {
    attributes: _block_json__WEBPACK_IMPORTED_MODULE_4__.attributes,
    isEligible(attrs) {
      var _attrs$wrapperClassNa, _attrs$wrapperStyle2;
      if (attrs?.madeitHasUserEdits) return false;
      ...
      const ws = ((_attrs$wrapperStyle2 = attrs?.wrapperStyle) !== null && _attrs$wrapperStyle2 !== void 0 ? _attrs$wrapperStyle2 : '').replace(/\s+/g, '');
  ...
  // isEligible herkent de inline margin in de opgeslagen wrapperStyle.
  {
    attributes: _block_json__WEBPACK_IMPORTED_MODULE_4__.attributes,
    isEligible(attrs) {
      var _attrs$wrapperClassNa4, _attrs$wrapperStyle3;
      if (attrs?.madeitHasUserEdits) return false;
      const wrapperTokens = ((_attrs$wrapperClassNa4 = attrs?.wrapperClassName) !== null && _attrs$wrapperClassNa4 !== void 0 ? _attrs$wrapperClassNa4 : '').trim().split(/\s+/).filter(Boolean);
      ...
      const ws = ((_attrs$wrapperStyle3 = attrs?.wrapperStyle) !== null && _attrs$wrapperStyle3 !== void 0 ? _attrs$wrapperStyle3 : '').replace(/\s+/g, '');
      if (!ws) return false;
  ...
  // wrappers met inline container margin.
  {
    attributes: _block_json__WEBPACK_IMPORTED_MODULE_4__.attributes,
    isEligible(attrs) {
      var _attrs$wrapperStyle4;
      if (attrs?.madeitHasUserEdits) return false;
      const ws = ((_attrs$wrapperStyle4 = attrs?.wrapperStyle) !== null && _attrs$wrapperStyle4 !== void 0 ? _attrs$wrapperStyle4 : '').replace(/\s+/g, '');
      if (!ws) return false;
      return (ws.includes('margin-top:') || ws.includes('margin-bottom:')) && !ws.includes('--madeit-container-margin');
    },
    save: _save_versions__WEBPACK_IMPORTED_MODULE_6__.saveV5,
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   saveV12: () => (/* reexport safe */ _saveV2__WEBPACK_IMPORTED_MODULE_7__["default"]),
/* harmony export */   saveV13: () => (/* reexport safe */ _saveV1__WEBPACK_IMPORTED_MODULE_8__["default"]),
/* harmony export */   saveV5: () => (/* reexport safe */ _saveV5__WEBPACK_IMPORTED_MODULE_6__["default"]),
...
/* harmony import */ var _saveV5__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./saveV5 */ "./src/save-versions/saveV5.js");
/* harmony import */ var _saveV2__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./saveV2 */ "./src/save-versions/saveV2.js");
/* harmony import */ var _saveV1__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./saveV1 */ "./src/save-versions/saveV1.js");
/**
...
function save(props) {
  ...
  const mwD = getResponsiveValue(maxWidth, maxWidthUnit, maxWidthCustom);
  const mwT = getResponsiveValue(maxWidthTablet, maxWidthUnitTablet || maxWidthUnit, maxWidthCustomTablet || maxWidthCustom);
  const mwM = getResponsiveValue(maxWidthMobile, maxWidthUnitMobile || maxWidthUnitTablet || maxWidthUnit, maxWidthCustomMobile || maxWidthCustomTablet || maxWidthCustom);
