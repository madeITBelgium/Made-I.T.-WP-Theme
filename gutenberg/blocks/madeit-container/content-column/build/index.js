...
/* harmony import */ var _shared__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../../shared */ "../../../shared/index.js");
...
function ColumnEdit(props) {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_8__.__)(item.label, 'madeit')));
    ...
    variant: "tertiary",
    onClick: () => {
      const values = [margin?.top, margin?.right, margin?.bottom, margin?.left];
      const allEqual = values.every(val => val === values[0]);
      if (allEqual) {
        setMargin({
          top: undefined,
  ...
  deprecated: [{
    ...
    save: function (props) {
      ...
      if (hasBackground && !hasInnerWrapper) {
        const legacyWrapperClasses = classnames__WEBPACK_IMPORTED_MODULE_1___default()('madeit-content-column__inner', wrapperClasses, {
          'has-background': !!backgroundColorClass,
          [backgroundColorClass]: backgroundColorClass
        });
        const legacyStyle = {
