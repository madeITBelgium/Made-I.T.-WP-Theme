...
add_action('enqueue_block_editor_assets', function (): void {
    ...
    wp_enqueue_style('madeit-shared-editor-controls', $shared_src, [], MADEIT_VERSION);

    wp_register_style('madeit-block-editor-inline', false, [], MADEIT_VERSION);
    ...
    wp_register_script('madeit-block-editor-inline', '', [], MADEIT_VERSION, true);
...
add_action('wp_enqueue_scripts', function (): void {
    ...
    wp_enqueue_style('madeit-shared-frontend-utilities', $shared_src, [], MADEIT_VERSION);
});
