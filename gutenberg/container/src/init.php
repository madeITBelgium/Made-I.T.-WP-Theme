...
function container_madeit_block_assets()
{
    ...
    wp_enqueue_style(
        ...
        get_theme_file_uri().'/gutenberg/container/dist/blocks.style.build.css', // Block style CSS.
...
function container_madeit_editor_assets()
{
    ...
    wp_enqueue_script(
        ...
        get_theme_file_uri().'/gutenberg/container/dist/blocks.build.js', // Block.build.js: We register the block here. Built with Webpack.
    ...
    wp_enqueue_style(
        ...
        get_theme_file_uri().'/gutenberg/container/dist/blocks.editor.build.css', // Block editor CSS.
