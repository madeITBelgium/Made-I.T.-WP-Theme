...
export const { RichText } = wp.editor
export const { IconButton, Spinner } = wp.components
export const { BACKSPACE, DELETE } = wp.keycodes
...
class GalleryImage extends Component {
    ...
    render() {
        const { url, alt, id, link, isSelected, caption, onRemove, setAttributes } = this.props;
