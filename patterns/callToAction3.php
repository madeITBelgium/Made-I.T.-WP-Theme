...
<!-- wp:madeit/block-content-column {"width":6} -->
<div class="wp-block-madeit-block-content-column col-12 col-lg-6"><div class="madeit-content-column__inner"><!-- wp:image {"id":2533,"aspectRatio":"4/3","scale":"cover","sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image size-full"><img src="https://test.madeit.be/wp-content/uploads/2026/05/placeholder-1.png" alt="" class="wp-image-2533" style="aspect-ratio:4/3;object-fit:cover"/></figure>
<!-- /wp:image --></div></div>
<!-- /wp:madeit/block-content-column -->
